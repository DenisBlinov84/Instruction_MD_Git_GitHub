...
# Первый файл по контролю версий Для написания заголовка напишите хэштег перед надписью 

## Выделение текста. Для выделения текста напишите 2 хэштега перед надписью 

Для выделения текста курсивом обрамите его звёздочками *Курсив.*

**Полужирный Для написания полужирного текста обрамите его с двух сторон двумя звёздочками**
## Списки Для написания списка перед надписью поставьте 2 хэштега
* Элемент1 Для написания элемента списка перед надписью поставьте звёздочку
* Элемент2
* Элемент3

1. Первый элемент нумерованого списка. Для написания элемента нумерованного списка напишите цифру с точкой перед текстом
2. Второй элемент
